          ...
          + New Transfer
            ...
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-3 lg:grid-cols-2">
                <div className="bg-white overflow-hidden rounded-lg shadow-sm border border-gray-200">
                    <div className="p-5">
                        <div className="flex items-center justify-between mb-4">
                            <div className="text-sm font-medium text-gray-500">Total Redeemed Points</div>
                            <Wallet className="h-5 w-5 text-primary-500" />
                        </div>
                        <div className="text-3xl font-semibold text-gray-900">0 Points</div>
                ...
                <div className="bg-white overflow-hidden rounded-lg shadow-sm border border-gray-200">
                    <div className="p-5">
                        <div className="flex items-center justify-between mb-4">
                            <div className="text-sm font-medium text-gray-500">Total Amount Redeemed</div>
                            <Calendar className="h-5 w-5 text-warning-500" />
                        </div>
                        <div className="text-3xl font-semibold text-gray-900">RWF 0</div>
                    </div>
                </div>
            ...
            {showNewTransfer && (
                <div className="bg-white overflow-hidden rounded-lg shadow-sm border border-gray-200 p-5">
                    <div className="flex justify-between items-center mb-5">
                        {/* <h3 className="text-lg font-medium text-gray-900">New Redeem</h3> */}
                        <button
